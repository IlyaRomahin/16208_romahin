...
public:	
	void strategy( Dealer &dealer, const bool first ) override {
		...
		if ( first ) {
		  ...
		  while ( ( dealer.hand_1.weight < 17 && ( dealer.deck.deck_data[ 2 ].value == "ace" || dealer.deck.deck_data[ 2 ].value == "10"
		  	|| dealer.deck.deck_data[ 2 ].value == "9" || dealer.deck.deck_data[ 2 ].value == "8" ) ) || dealer.hand_1.weight < 16 ) {	
		  ...
		  while ( ( dealer.hand_2.weight < 17 && ( dealer.deck.deck_data[ 0 ].value == "ace" || dealer.deck.deck_data[ 0 ].value == "10"
		    || dealer.deck.deck_data[ 0 ].value == "9" || dealer.deck.deck_data[ 0 ].value == "8" ) ) || dealer.hand_2.weight < 16 ) {
