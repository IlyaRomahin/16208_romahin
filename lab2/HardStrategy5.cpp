...
public:	
	void strategy( Dealer &dealer, const bool first ) override {
		...
		if ( first ) {
		  ...
		  while ( ( dealer.hand_1.weight < 18 && ( dealer.deck.deck_data[ 2 ].value == "ace" || dealer.deck.deck_data[ 2 ].value == "jack"
		    || dealer.deck.deck_data[ 2 ].suit == "spades" ) ) || dealer.hand_1.weight < 17 ) {
		  ...
		  while ( ( dealer.hand_2.weight < 18 && ( dealer.deck.deck_data[ 0 ].value == "ace" || dealer.deck.deck_data[ 0 ].value == "jack"
		    || dealer.deck.deck_data[ 0 ].suit == "spades" ) ) || dealer.hand_2.weight < 17 ) {
...
Factory< Strategy, Strategy*(*)(), std::string>::get_instance()->
	regist3r( "hardstrategy5", []() -> Strategy * { return new HardStrategy5; } );
}
